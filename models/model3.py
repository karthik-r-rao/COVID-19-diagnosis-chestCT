...
class mymodel(torch.nn.Module):
  ...
  def __init__(self):
    ...
    self.conv1 = self.blocktype3(3, 64)
    ...
    #self.p4 = self.pointwiseconv(256,256)
    ...
    #self.p6 = self.pointwiseconv(512,512)
    self.conv7 = self.blocktype2(512,1024)
    self.maxpool5 = torch.nn.MaxPool2d(kernel_size=2)

    self.fc1 = self.fclayer(7*7*1024, 128)
    #self.fc2 = self.fclayer(4096,128)
    self.fc3 = self.fclayer(128,2)
    self.gradients = None
